...
const doomfist = {
    ...
    difficulty: "3/3",
    img: "doomfist.png",
    Phrase: "ONLY THROUGH CONFLICT DO WE EVOLVE.",
    ...
    ability:[
        {
            name: "SEISMIC SLAM",
            discription: "Leap forward and smash the ground."
        },
        {
            name: "RISING UPPERCUT",
            discription: "Knock an enemy into the air."
        },
        {
            name: "ROCKET PUNCH",
            discription: "Hold to charge then release to launch forward and knock an enemy back. Damage increases if the enemy hits a wall."
        },
        {
            name: "METEOR STRIKE",
            discription: "Press Q to leap up into the air. Move the targeting circle, then press ABILITY 3 to strike the targeted area."
        },
        {
            name: "THE BEST DEFENSE...",
            discription: "Dealing damage with abilities creates temporary personal shields."
        }
    ]
...
const mercy = {
    ...
    ability:[
        {
            name: "GUARDIAN ANGEL",
            discription: "Fly towards an ally."
        },
        {
            name: "RESURRECT",
            discription: "Revive a dead teammate."
        },
        {
            name: "ANGELIC DESCENT",
            discription: "Fall very slowly."
        },
        {
            name: "VALKYRIE",
            discription: "Gain the ability to fly. Abilities are enhanced."
        },
        {
            name: "REGENERATION",
            discription: "Automatically heal over time."
        }
    ]
...
let heroes = ["mercy", "doomfist", "sombra"];
